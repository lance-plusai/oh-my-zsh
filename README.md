...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/lance-plusai/oh-my-zsh/master/tools/install.sh)"
```

#### via wget

```shell
sh -c "$(wget https://raw.githubusercontent.com/lance-plusai/oh-my-zsh/master/tools/install.sh -O -)"
```
